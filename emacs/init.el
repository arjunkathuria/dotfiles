...
(custom-set-variables
 ...
 '(package-selected-packages
   '(tree-sitter tree-sitter-langs modus-themes prettier dash devdocs lsp-pyright envrc nix-mode nix-modeline ormolu reformatter sublime-themes catppuccin-theme cider flatland-theme all-the-icons-completion corfu-doc consult-flycheck flycheck-aspell zenburn-theme consult-projectile consult-eglot eglot diff-hl whitespace-cleanup-mode which-key hl-indent minions consult-yasnippet yasnippet kind-icon cape corfu dante orderless vertico dhall-mode consult-dir consult-lsp line-reminder org-noter-pdftools org-noter timu-spacegrey-theme ox-hugo yaml-imenu yaml-mode visual-fill-column snazzy-theme embark-consult git-link oceanic-theme sketch-themes good-scroll mini-frame marginalia consult ctrlf shell-switcher hindent kaolin-themes hybrid-reverse-theme purescript-mode org-notifications org-roam side-hustle projectile vterm vterm-toggle rcirc-alert doom-modeline doom-themes multiple-cursors solarized-theme magit-org-todos org gnu-elpa-keyring-update circadian define-it org-alert org-link-beautify define-word org-bullets nov suggestion-box metronome transpose-frame lsp-mode immaterial-theme string-inflection paredit all-the-icons-dired all-the-icons-ibuffer lsp-haskell use-package lsp-ui flycheck-haskell haskell-mode pipenv all-the-icons dashboard exec-path-from-shell whole-line-or-region lorem-ipsum irony nordless-theme color-theme-sanityinc-tomorrow spacegray-theme dad-joke nord-theme bm markdown-mode flyspell-popup web-mode vi-tilde-fringe undo-tree rjsx-mode restart-emacs rainbow-mode rainbow-delimiters neotree material-theme magit json-mode js2-refactor git-gutter flycheck-pos-tip emmet-mode color-theme-sanityinc-solarized base16-theme ag ace-window)))
