...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ayu-theme yaml-imenu yaml-mode visual-fill-column snazzy-theme embark-consult git-link oceanic-theme sketch-themes good-scroll mini-frame-mode mini-frame lsp-treemacs treemacs-projectile treemacs treemacs-all-the-icons treemacs-magit marginalia consult ctrlf shell-switcher selectrum hindent kaolin-themes hybrid-reverse-theme purescript-mode org-notifications org-roam side-hustle projectile vterm vterm-toggle rcirc-alert doom-modeline doom-themes zenburn-theme vscode-icon dracula-theme multiple-cursors solarized-theme magit-org-todos org gnu-elpa-keyring-update circadian define-it org-alert org-link-beautify define-word ivy-rich saveplace-pdf-view org-noter-pdftools org-pdftools org-pdfview org-bullets rainbow-delimiters-mode vi-tilde-fringe-mode nov pdf-tools pdf-view-restore pdfgrep suggestion-box metronome transpose-frame lsp-ui-mode lsp-mode immaterial-theme string-inflection paredit all-the-icons-dired all-the-icons-ibuffer ebal lsp-haskell all-the-icons-ivy-rich use-package lsp-ui company-statistics company-c-headers company-rtags company-lsp flycheck-haskell haskell-mode elpy pipenv company-jedi all-the-icons-ivy slime-company brutalist-theme nofrils-acme-theme all-the-icons dashboard exec-path-from-shell whole-line-or-region lorem-ipsum company-irony irony edts nordless-theme color-theme-sanityinc-tomorrow company-erlang spacegray-theme overcast-theme dad-joke danneskjold-theme nord-theme erlang bm markdown-mode arjen-grey-theme flyspell-popup flycheck-elixir alchemist elixir-mode web-mode vi-tilde-fringe undo-tree surround rjsx-mode restart-emacs rainbow-mode rainbow-delimiters prettier-js osx-dictionary neotree material-theme magit json-mode js2-refactor gitconfig-mode git-gutter flycheck-pos-tip emmet-mode counsel company-web company-tern color-theme-sanityinc-solarized base16-theme ag ace-window))
