...
(custom-set-variables
 ...
 '(package-selected-packages
   '(zig-mode tide consult-flyspell olivetti ac-mozc flymake-haskell-multi haskell-snippets ef-themes pdf-tools org-noter-pdftools org-pdftools electric-spacing org-modern smartparens rust-mode tree-sitter-ispell boon tree-sitter tree-sitter-langs modus-themes prettier dash devdocs envrc nix-mode nix-modeline ormolu reformatter sublime-themes catppuccin-theme cider flatland-theme all-the-icons-completion corfu-doc zenburn-theme consult-projectile consult-eglot eglot diff-hl whitespace-cleanup-mode which-key hl-indent minions consult-yasnippet yasnippet kind-icon cape corfu orderless vertico dhall-mode consult-dir line-reminder timu-spacegrey-theme ox-hugo yaml-imenu yaml-mode visual-fill-column snazzy-theme embark-consult git-link oceanic-theme sketch-themes good-scroll mini-frame marginalia consult ctrlf shell-switcher hindent kaolin-themes hybrid-reverse-theme purescript-mode org-notifications org-roam side-hustle projectile vterm vterm-toggle rcirc-alert doom-modeline doom-themes multiple-cursors solarized-theme magit-org-todos org gnu-elpa-keyring-update circadian org-alert org-link-beautify define-word org-bullets nov suggestion-box metronome transpose-frame immaterial-theme string-inflection paredit all-the-icons-dired all-the-icons-ibuffer use-package haskell-mode pipenv all-the-icons dashboard exec-path-from-shell whole-line-or-region lorem-ipsum irony nordless-theme color-theme-sanityinc-tomorrow spacegray-theme dad-joke nord-theme bm markdown-mode flyspell-popup web-mode vi-tilde-fringe undo-tree restart-emacs rainbow-mode rainbow-delimiters neotree material-theme magit json-mode js2-refactor git-gutter emmet-mode color-theme-sanityinc-solarized base16-theme ag ace-window))
